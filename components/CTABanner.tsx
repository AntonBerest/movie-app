    ...
    return (
        <div className="relative mx-16 my-12 rounded-xl overflow-hidden h-150">
            ...
            <div className="absolute inset-0 flex justify-between items-center px-16">
                ...
                <div>
                    <h1 className="text-4xl font-bold mb-4 text-white">Start your free trial today!</h1>
                    <p className="text-zinc-400 mb-8">This is a clear and concise call to action that encourages users to sign up for a free trial of StreamVibe.</p>
                </div>

                <div>
                    <button className="bg-red-700 text-white rounded-lg px-4 py-2">Start a Free Trail</button>
                </div>
